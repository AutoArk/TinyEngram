...
class TrainingArguments(transformers.TrainingArguments):
    ...
    use_lora: bool = True
    lora_rank: int = 64 # Helper argument to pass from script, though LoraArguments handles it usually.
...
def train():
    ...
    # Use AutoModelForCausalLM for standard LoRA training
    ...
    if training_args.use_lora:
        rank0_print(f"Applying LoRA with rank {lora_args.lora_r}")
        ...
        # Determine number of trainable params
        trainable_params, all_param = model.get_nb_trainable_parameters()
        rank0_print(f"trainable params: {trainable_params:,d} || all params: {all_param:,d} || trainable%: {100 * trainable_params / all_param:.4f}")
